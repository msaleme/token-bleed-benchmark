...
At the 1,200-item holdout, answer-key size ranges from 7 to 18 fields (mean 12.05). The nominal 5% condition removes 0 or 1 field (mean 0.90), for a mean realized miss rate of 7.38% and range 0.00%-10.00%. The nominal 10% condition removes 1 or 2 fields (mean 1.10), for a mean realized miss rate of 9.22% and range 7.14%-14.29%. The labels name frozen nominal conditions; the discrete realized removals are the actual experimental perturbations.
